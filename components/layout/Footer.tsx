    ...
    <footer className="bg-charcoal-dark text-ivory/80 mt-24">
            ...
            <div className="flex gap-4">
              {[
                ...
                <a
                  key={i}
                  href={href}
                  className="w-9 h-9 border border-ivory/20 flex items-center justify-center text-ivory/60 hover:border-rose-gold hover:text-rose-gold transition-all duration-300"
                >
                  <Icon size={16} />
                </a>
              ))}
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm font-inter text-ivory/60 hover:text-rose-gold transition-colors duration-200"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-sm font-inter">
                ...
                <a href="mailto:hello@azaleabyzehra.com" className="text-ivory/60 hover:text-rose-gold transition-colors">
                  hello@azaleabyzehra.com
                </a>
              </li>
            </ul>
      ...
      <div className="border-t border-ivory/10">
        <div className="section-padding py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs font-inter text-ivory/40">
            © {new Date().getFullYear()} Azalea by Zehra. All rights reserved.
          </p>
